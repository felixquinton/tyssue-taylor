...
LICENSE = 'MPL-2.0'
DOWNLOAD_URL = 'https://github.com/felixquinton/tyssue-taylor.git'
...
def write_version_py(filename='tyssue_taylor/version.py'):
    cnt = """
# THIS FILE IS GENERATED FROM tyssue-taylor SETUP.PY
#
